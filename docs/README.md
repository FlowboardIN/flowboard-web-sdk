...
```html
<script src="https://cdn.jsdelivr.net/gh/FlowboardIN/flowboard-web-sdk@1.0.2/lib/bundle/flowboard.min.js"></script>
```
...
<link
  rel="stylesheet"
  href="https://cdn.jsdelivr.net/gh/FlowboardIN/flowboard-web-sdk@1.0.2/lib/bundle/flowboard.min.css"
/>
```
